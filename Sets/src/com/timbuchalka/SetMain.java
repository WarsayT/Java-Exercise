...
public class SetMain {
    public static void main(String[] args) {
        ...
        if (nature.containsAll(divine)) {
            ...
            System.out.println("divine is a not subset of nature");
        }

        if (nature.containsAll(intersectionTest)) {
            System.out.println("intersectionTest is a subset of nature");
        } else {
            System.out.println("intersectionTest is a not subset of nature");
        }

        if (divine.containsAll(intersectionTest)) {
            System.out.println("intersectionTest is a subset of divine");
        } else {
            System.out.println("intersectionTest is a not subset of divine");
        }
